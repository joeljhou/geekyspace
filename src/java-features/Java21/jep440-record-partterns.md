...
到目前为止，Java中的模式匹配主要局限于匹配类型：[instanceof类型匹配](../Java16/jep394-pattern-matching-for-instanceof)
...
Java
21扩展了这个概念，使其可用于switch语句和表达式: [switch的模式匹配](jep441-pattern-matching-for-switch)
